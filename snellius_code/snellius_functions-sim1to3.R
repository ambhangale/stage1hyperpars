...
# nClus <- parallel::detectCores() - 1L
# cl <- makePSOCKcluster(nClus)
# clusterExport(cl = cl, varlist = c("getSigma", "genData", "genGroups", "minLoss",
# "thoughtful_priors", "prophetic_priors", "ANOVA_priors", "FIML_priors", "set_priors",
# "s1sat", "ogsat"))
